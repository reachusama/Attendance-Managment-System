    ...
    public partial class TeacherSettings : Form
    {
        ...
        private void btn_ChangePass_Click(object sender, EventArgs e)
        {
            if (comboBox_Option.Text == "CHANGE PASSWORD")
            {
                ...
                {
                    if (mysql.changeTeacherPassword(userId, textBox_NewPass.Text, textBox_OldPass.Text))
                    {
            ...
            else
            {
                ...
                {
                    if (mysql.changeTeacherUserName(userId, textBox_NewPass.Text, textBox_OldPass.Text))
                    {
                        label_Message.ForeColor = Color.Green;
